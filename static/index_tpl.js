...
var X2DBBgResources = {
  ...
  resourcesArr: [
    ...
    // 这里的顺序就是资源在页面加载的顺序
    {id: 'app.css', url: 'static/css/app', type: 'style'},
    {id: 'manifest.js', url: 'static/js/manifest', type: 'script'},
    {id: 'vendor.js', url: 'static/js/vendor', type: 'script'},
    {id: 'app.js', url: 'static/js/app', type: 'script'}
  ]
}
