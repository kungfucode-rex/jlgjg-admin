...
var X2DBBgResources = {
  ...
  version: 1513083622,// 每次发版都会生成一个新的数据库版本(时间戳秒数)
  db: null,
  resourcesArr: [
    ...
    {id: 'manifest.js', url: 'static/js/manifest.25b30b7888d9512c97cd.js', type: 'script'},
    {id: 'vendor.js', url: 'static/js/vendor.f7bf9bfb74ad55eefc69.js', type: 'script'},
    {id: 'app.js', url: 'static/js/app.4712c9d9141ca13e108a.js', type: 'script'}
  ]
}
